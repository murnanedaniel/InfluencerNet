...
class InfluencerTransformer(InfluencerBase):
    def __init__(self, hparams):
        ...
        self.hparams["nb_transformer_layers"] = hparams["nb_layer"] if "nb_transformer_layers" not in hparams else hparams["nb_transformer_layers"]
        ...
        self.transformer_encoder = nn.TransformerEncoder(self.transformer_layer, num_layers=self.hparams["nb_transformer_layers"])
